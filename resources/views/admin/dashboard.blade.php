...
@section('content')
<!-- Hero -->
<div class="bg-image" style="background-image: url('{{ asset('admin-assets/media/various/bg_dashboard.jpg') }}');">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center">
                                    <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('admin-assets/media/avatars/avatar3.jpg') }}" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('admin-assets/media/avatars/avatar10.jpg') }}" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('admin-assets/media/avatars/avatar11.jpg') }}" alt="">
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <img class="img-avatar img-avatar32 img-avatar-thumb" src="{{ asset('admin-assets/media/avatars/avatar13.jpg') }}" alt="">
                                </td>
                                <td>
