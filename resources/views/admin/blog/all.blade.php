...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">List <small>blog</small></h3>
            <a href="{{ url('admin/blog/add') }}" class="btn btn-primary">+ New Blog</a>
        </div>
            ...
            <table class="table table-bordered table-striped table-vcenter js-dataTable-full">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <img src="{{ $blog->image_s3 }}" width="60px" />
                        </td>
                        <td class="font-w600">{{ $blog->title }}</td>
                        <td>
                            <em class="text-muted">{{ date_format(date_create($blog->created_at), 'M d, Y') }}</em>
                        </td>
                        <td>
                            <a href="{{ url('admin/blog/view/' . $blog->id) }}" ><i class="si si-eye"></i></a>
                            <a href="{{ url('admin/blog/edit/' . $blog->id) }}" ><i class="si si-pencil"></i></a>
                            <a href="javascript:void(0);" onclick="onRemoveBlog({{ $blog->id }})"><i class="si si-trash"></i></a>
                        </td>
                    </tr>
                    @php $i ++; @endphp
                    @endforeach
...
<div class="modal" id="modal-delete-blog" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="block block-themed block-transparent mb-0">
                <div class="block-header bg-primary-dark">
                    <h3 class="block-title">Delete Blog</h3>
                ...
                <div class="block-content">
                    <p>Are you sure to remove this blog?</p>
                </div>
...
function onRemoveBlog(blog_id) {
    $("#modal-delete-blog .btn-primary").attr('href', "{{ url('admin/blog/delete') }}" + '/' + blog_id);
    $("#modal-delete-blog").modal('show');
}
</script>
@endsection
