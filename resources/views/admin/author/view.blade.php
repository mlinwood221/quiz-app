...
<div class="content">
    ...
    <div class="block block-rounded block-bordered">
        <div class="block-header block-header-default">
            <h3 class="block-title">View Author Info</h3>
        </div>
        <div class="block-content">
            <form id="form-author-info" action="be_forms_elements.html" method="POST" enctype="multipart/form-data" onsubmit="event.preventDefault();">
                <!-- Basic Elements -->
                <div class="row push">
                    <div class="col-md-6">
                        <div class="form-group username">
                            <label for="example-text-input">Username</label>
                            <input type="text" class="form-control" placeholder="" maxlength="255" value="{{ $author->username }}" disabled>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group firstname">
                            ...
                            <input type="text" class="form-control" placeholder="" maxlength="255" value="{{ $author->firstname }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group lastname">
                            <label for="example-text-input">Lastname</label>
                            <input type="text" class="form-control" placeholder="" maxlength="255" value="{{ $author->lastname }}" disabled>
                        </div>
                    </div>
                    <div class="col-md-12">
...
var main_image = "{{ $author->image_s3 }}";
