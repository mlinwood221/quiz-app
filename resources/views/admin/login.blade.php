                                ...
                                <div class="col-md-6 order-md-1 bg-white">
                                    <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                        ...
                                        <div class="mb-2 text-center">
                                            <a class="link-fx font-w700 font-size-h1" href="{{ url('/admin') }}">
                                                <span class="text-dark">QuizzlyBears</span>
                                            </a>
                                    ...
                                    <div class="block-content block-content-full px-lg-5 py-md-5 py-lg-6">
                                        <div class="media">
                                            <a class="img-link mr-3" href="javascript:void(0)">
                                                <img class="img-avatar img-avatar-thumb" src="{{ asset('admin-assets/media/avatars/avatar9.jpg') }}" alt="">
                                            </a>
