                    ...
                    <div class="row align-items-center justify-content-center">
                        <div class="col-lg-4 wow fadeIn" data-wow-delay=".5s">
                            <div class="box-rounded padding40" data-bgcolor="#ffffff">
                                ...
                                @endif
                                <form class="form-border" method="post" action="{{ route('password.email') }}">
                                    @csrf
                                    ...
                                    <div class="field-set">
                                        <input type='submit' value="{{ __('Send Password Reset Link') }}" class="btn btn-main btn-fullwidth color-2">
                                    </div>
